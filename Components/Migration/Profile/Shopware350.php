<?php
/**
 * Shopware migration profile component to import a shopware 3.5.0 database and return the imported data for the allocation.
 *
 *
 * @copyright Copyright (c) 2011, Shopware AG
 * @author h.lohaus
 * @package Shopware
 * @subpackage Components_Migration
 * @copyright Copyright (c) 2011, shopware AG
 * @version
 */
